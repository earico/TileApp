...
function showInfo() {
    document.getElementById('info').innerHTML = `
        ${NL_APPID} is running on portss ${NL_PORT} inside ${NL_OS}
        <br/><br/>
...
function onWindowStart() {
    //let fs = Neutralino.window.isFullScreen();
    //console.log(fs);
...
function showNotif() {
    Neutralino.os.showNotification('Testing', 'content');
    Neutralino.os.showMessageBox('Testing', 'content2')
}
...
showInfo();
onWindowStart(); // for this function, permissions need to be granted in the neutralino.config.json. read the docs!!!!!!!